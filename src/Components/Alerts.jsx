...
export default function Alerts({tipo, msg}) {
    console.log(tipo, msg)
    if(tipo === "erro"){
        return <AlertErro msg={msg} />
    }else if (tipo === "sucesso"){
        return <AlertSucesso msg={msg} />
    } else if(tipo === "copia") {
        console.log("cópia")
        return <AlertCopia msg={msg} />
    } else {
        return null;
    }
